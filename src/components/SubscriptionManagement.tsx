  ...
  return (
    <div className={className}>
      <div className="flex flex-col lg:flex-row gap-6">
        <Card className="relative bg-white dark:bg-black border border-black/20 dark:border-white/20 flex-grow">
          <CardHeader>
                ...
                <div className="space-y-4">
                  ...
                  {subscriptionData?.status === 'active' && (
                    <Alert className="bg-blue-500/10 border-blue-500/20 text-blue-700 dark:text-blue-400">
                      ...
                      <AlertDescription className="ml-2">
                        Your subscription will automatically renew on {formatDate(subscriptionData.renewalDate)}. You can cancel anytime.
                      </AlertDescription>
                    </Alert>
                  )}
                </div>
          ...
          <CardFooter className="flex flex-wrap gap-3">
            {subscriptionData?.plan === 'pro' && subscriptionData?.status === 'active' ? (
              ...
              <>
                ...
                <Button 
                  className="gap-2 flex-1 bg-black dark:bg-white text-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 shadow-[0_4px_0_0_rgba(0,0,0,1)] dark:shadow-[0_4px_0_0_rgba(255,255,255,1)] transform transition-all active:translate-y-1 active:shadow-none"
